...
######################################
### Calculating efficiencies for firsts jets
######################################
...
for s in samples:
       df[s] = df[s].Define('pt_jetgood_1','Jet_pt[JetGoodInd[0]]')
       df[s] = df[s].Define('pt_jetgood_2','Jet_pt[JetGoodInd[1]]')
       df[s] = df[s].Define('pt_jetgood_3','Jet_pt[JetGoodInd[2]]')
       df[s] = df[s].Define('pt_jetgood_4','Jet_pt[JetGoodInd[3]]')

       df_1_bottom[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[0]]) == 5')
       df_1_charm[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[0]]) == 4')
       df_1_light[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[0]]) != 4 && fabs(Jet_hadronFlavour[JetGoodInd[0]]) != 5')
       df_2_bottom[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[1]]) == 5')
       df_2_charm[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[1]]) == 4')
       df_2_light[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[1]]) != 4 && fabs(Jet_hadronFlavour[JetGoodInd[0]]) != 5')
       df_3_bottom[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[2]]) == 5')
       df_3_charm[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[2]]) == 4')
       df_3_light[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[2]]) != 4 && fabs(Jet_hadronFlavour[JetGoodInd[0]]) != 5')
       df_4_bottom[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[3]]) == 5')
       df_4_charm[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[3]]) == 4')
       df_4_light[s] = df[s].Filter('fabs(Jet_hadronFlavour[JetGoodInd[3]]) != 4 && fabs(Jet_hadronFlavour[JetGoodInd[0]]) != 5')

       df_1_bottom[s] = df_1_bottom[s].Define('eff_bottom_medium_1','Jet_btagDeepFlavB[JetGoodInd[0]] >=' +str(cuts_btag[years[0]][1])+ '? 1 : 0')
       df_1_bottom[s] = df_1_bottom[s].Define('eff_bottom_loose_1','Jet_btagDeepFlavB[JetGoodInd[0]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')
       df_1_charm[s] = df_1_charm[s].Define('eff_charm_medium_1','Jet_btagDeepFlavB[JetGoodInd[0]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_1_charm[s] = df_1_charm[s].Define('eff_charm_loose_1','Jet_btagDeepFlavB[JetGoodInd[0]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')
       df_1_light[s] = df_1_light[s].Define('eff_light_medium_1','Jet_btagDeepFlavB[JetGoodInd[0]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_1_light[s] = df_1_light[s].Define('eff_light_loose_1','Jet_btagDeepFlavB[JetGoodInd[0]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')

       df_2_bottom[s] = df_2_bottom[s].Define('eff_bottom_medium_2','Jet_btagDeepFlavB[JetGoodInd[1]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_2_bottom[s] = df_2_bottom[s].Define('eff_bottom_loose_2','Jet_btagDeepFlavB[JetGoodInd[1]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')
       df_2_charm[s] = df_2_charm[s].Define('eff_charm_medium_2','Jet_btagDeepFlavB[JetGoodInd[1]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_2_charm[s] = df_2_charm[s].Define('eff_charm_loose_2','Jet_btagDeepFlavB[JetGoodInd[1]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')
       df_2_light[s] = df_2_light[s].Define('eff_light_medium_2','Jet_btagDeepFlavB[JetGoodInd[1]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_2_light[s] = df_2_light[s].Define('eff_light_loose_2','Jet_btagDeepFlavB[JetGoodInd[1]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')

       df_3_bottom[s] = df_3_bottom[s].Define('eff_bottom_medium_3','Jet_btagDeepFlavB[JetGoodInd[2]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_3_bottom[s] = df_3_bottom[s].Define('eff_bottom_loose_3','Jet_btagDeepFlavB[JetGoodInd[2]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')
       df_3_charm[s] = df_3_charm[s].Define('eff_charm_medium_3','Jet_btagDeepFlavB[JetGoodInd[2]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_3_charm[s] = df_3_charm[s].Define('eff_charm_loose_3','Jet_btagDeepFlavB[JetGoodInd[2]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')
       df_3_light[s] = df_3_light[s].Define('eff_light_medium_3','Jet_btagDeepFlavB[JetGoodInd[2]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_3_light[s] = df_3_light[s].Define('eff_light_loose_3','Jet_btagDeepFlavB[JetGoodInd[2]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')

       df_4_bottom[s] = df_4_bottom[s].Define('eff_bottom_medium_4','Jet_btagDeepFlavB[JetGoodInd[3]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_4_bottom[s] = df_4_bottom[s].Define('eff_bottom_loose_4','Jet_btagDeepFlavB[JetGoodInd[3]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')
       df_4_charm[s] = df_4_charm[s].Define('eff_charm_medium_4','Jet_btagDeepFlavB[JetGoodInd[3]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_4_charm[s] = df_4_charm[s].Define('eff_charm_loose_4','Jet_btagDeepFlavB[JetGoodInd[3]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')
       df_4_light[s] = df_4_light[s].Define('eff_light_medium_4','Jet_btagDeepFlavB[JetGoodInd[3]] >=' +str(cuts_btag[years[0]][1])+ ' ? 1 : 0')
       df_4_light[s] = df_4_light[s].Define('eff_light_loose_4','Jet_btagDeepFlavB[JetGoodInd[3]] >=' +str(cuts_btag[years[0]][0])+ ' ? 1 : 0')
...
prof_1_botflav_mediumbtag_eff_pt = {}
prof_1_botflav_loosebtag_eff_pt = {}
prof_1_charmflav_mediumbtag_eff_pt = {}
prof_1_charmflav_loosebtag_eff_pt = {}
prof_1_lightflav_mediumbtag_eff_pt = {}
prof_1_lightflav_loosebtag_eff_pt = {}

prof_2_botflav_mediumbtag_eff_pt = {}
prof_2_botflav_loosebtag_eff_pt = {}
prof_2_charmflav_mediumbtag_eff_pt = {}
prof_2_charmflav_loosebtag_eff_pt = {}
prof_2_lightflav_mediumbtag_eff_pt = {}
prof_2_lightflav_loosebtag_eff_pt = {}

prof_3_botflav_mediumbtag_eff_pt = {}
prof_3_botflav_loosebtag_eff_pt = {}
prof_3_charmflav_mediumbtag_eff_pt = {}
prof_3_charmflav_loosebtag_eff_pt = {}
prof_3_lightflav_mediumbtag_eff_pt = {}
prof_3_lightflav_loosebtag_eff_pt = {}

prof_4_botflav_mediumbtag_eff_pt = {}
prof_4_botflav_loosebtag_eff_pt = {}
prof_4_charmflav_mediumbtag_eff_pt = {}
prof_4_charmflav_loosebtag_eff_pt = {}
prof_4_lightflav_mediumbtag_eff_pt = {}
prof_4_lightflav_loosebtag_eff_pt = {}
...
for s in samples:
  ...
  prof_1_botflav_mediumbtag_eff_pt[s] = df_1_bottom[s].Profile1D(("prof_1_botflav_mediumbtag", "",20,20,120), "pt_jetgood_1", "eff_bottom_medium_1")
  prof_1_botflav_loosebtag_eff_pt[s] = df_1_bottom[s].Profile1D(("prof_1_botflav_loosebtag", "",20,20,120), "pt_jetgood_1", "eff_bottom_loose_1")
  prof_1_charmflav_mediumbtag_eff_pt[s] = df_1_charm[s].Profile1D(("prof_1_charmflav_mediumbtag", "",20,20,120), "pt_jetgood_1", "eff_charm_medium_1")
  prof_1_charmflav_loosebtag_eff_pt[s] = df_1_charm[s].Profile1D(("prof_1_charmflav_loosebtag", "",20,20,120), "pt_jetgood_1", "eff_charm_loose_1")
  prof_1_lightflav_mediumbtag_eff_pt[s] = df_1_light[s].Profile1D(("prof_1_lightflav_mediumbtag", "",20,20,120), "pt_jetgood_1", "eff_light_medium_1")
  prof_1_lightflav_loosebtag_eff_pt[s] = df_1_light[s].Profile1D(("prof_1_lightflav_loosebtag", "",20,20,120), "pt_jetgood_1", "eff_light_loose_1")

  prof_2_botflav_mediumbtag_eff_pt[s] = df_2_bottom[s].Profile1D(("prof_2_botflav_mediumbtag", "",20,20,120), "pt_jetgood_2", "eff_bottom_medium_2")
  prof_2_botflav_loosebtag_eff_pt[s] = df_2_bottom[s].Profile1D(("prof_2_botflav_loosebtag", "",20,20,120), "pt_jetgood_2", "eff_bottom_loose_2")
  prof_2_charmflav_mediumbtag_eff_pt[s] = df_2_charm[s].Profile1D(("prof_2_charmflav_mediumbtag", "",20,20,120), "pt_jetgood_2", "eff_charm_medium_2")
  prof_2_charmflav_loosebtag_eff_pt[s] = df_2_charm[s].Profile1D(("prof_2_charmflav_loosebtag", "",20,20,120), "pt_jetgood_2", "eff_charm_loose_2")
  prof_2_lightflav_mediumbtag_eff_pt[s] = df_2_light[s].Profile1D(("prof_2_lightflav_mediumbtag", "",20,20,120), "pt_jetgood_2", "eff_light_medium_2")
  prof_2_lightflav_loosebtag_eff_pt[s] = df_2_light[s].Profile1D(("prof_2_lightflav_loosebtag", "",20,20,120), "pt_jetgood_2", "eff_light_loose_2")

  prof_3_botflav_mediumbtag_eff_pt[s] = df_3_bottom[s].Profile1D(("prof_3_botflav_mediumbtag", "",20,20,120), "pt_jetgood_3", "eff_bottom_medium_3")
  prof_3_botflav_loosebtag_eff_pt[s] = df_3_bottom[s].Profile1D(("prof_3_botflav_loosebtag", "",20,20,120), "pt_jetgood_3", "eff_bottom_loose_3")
  prof_3_charmflav_mediumbtag_eff_pt[s] = df_3_charm[s].Profile1D(("prof_3_charmflav_mediumbtag", "",20,20,120), "pt_jetgood_3", "eff_charm_medium_3")
  prof_3_charmflav_loosebtag_eff_pt[s] = df_3_charm[s].Profile1D(("prof_3_charmflav_loosebtag", "",20,20,120), "pt_jetgood_3", "eff_charm_loose_3")
  prof_3_lightflav_mediumbtag_eff_pt[s] = df_3_light[s].Profile1D(("prof_3_lightflav_mediumbtag", "",20,20,120), "pt_jetgood_3", "eff_light_medium_3")
  prof_3_lightflav_loosebtag_eff_pt[s] = df_3_light[s].Profile1D(("prof_3_lightflav_loosebtag", "",20,20,120), "pt_jetgood_3", "eff_light_loose_3")

  prof_4_botflav_mediumbtag_eff_pt[s] = df_4_bottom[s].Profile1D(("prof_4_botflav_mediumbtag", "",20,20,120), "pt_jetgood_4", "eff_bottom_medium_4")
  prof_4_botflav_loosebtag_eff_pt[s] = df_4_bottom[s].Profile1D(("prof_4_botflav_loosebtag", "",20,20,120), "pt_jetgood_4", "eff_bottom_loose_4")
  prof_4_charmflav_mediumbtag_eff_pt[s] = df_4_charm[s].Profile1D(("prof_4_charmflav_mediumbtag", "",20,20,120), "pt_jetgood_4", "eff_charm_medium_4")
  prof_4_charmflav_loosebtag_eff_pt[s] = df_4_charm[s].Profile1D(("prof_4_charmflav_loosebtag", "",20,20,120), "pt_jetgood_4", "eff_charm_loose_4")
  prof_4_lightflav_mediumbtag_eff_pt[s] = df_4_light[s].Profile1D(("prof_4_lightflav_mediumbtag", "",20,20,120), "pt_jetgood_4", "eff_light_medium_4")
  prof_4_lightflav_loosebtag_eff_pt[s] = df_4_light[s].Profile1D(("prof_4_lightflav_loosebtag", "",20,20,120), "pt_jetgood_4", "eff_light_loose_4")
...
for s in samples:
                ...
                prof_1_botflav_mediumbtag_eff_pt[s].Write()
                prof_1_botflav_loosebtag_eff_pt[s].Write()
                prof_1_charmflav_mediumbtag_eff_pt[s].Write()
                prof_1_charmflav_loosebtag_eff_pt[s].Write()
                prof_1_lightflav_mediumbtag_eff_pt[s].Write()                                                                                                       
                prof_1_lightflav_loosebtag_eff_pt[s].Write()

                prof_2_botflav_mediumbtag_eff_pt[s].Write()
                prof_2_botflav_loosebtag_eff_pt[s].Write()
                prof_2_charmflav_mediumbtag_eff_pt[s].Write()
                prof_2_charmflav_loosebtag_eff_pt[s].Write()
                prof_2_lightflav_mediumbtag_eff_pt[s].Write()                                                                                                       
                prof_2_lightflav_loosebtag_eff_pt[s].Write()

                prof_3_botflav_mediumbtag_eff_pt[s].Write()
                prof_3_botflav_loosebtag_eff_pt[s].Write()
                prof_3_charmflav_mediumbtag_eff_pt[s].Write()
                prof_3_charmflav_loosebtag_eff_pt[s].Write()
                prof_3_lightflav_mediumbtag_eff_pt[s].Write()                                                                                                       
                prof_3_lightflav_loosebtag_eff_pt[s].Write()

                prof_4_botflav_mediumbtag_eff_pt[s].Write()
                prof_4_botflav_loosebtag_eff_pt[s].Write()
                prof_4_charmflav_mediumbtag_eff_pt[s].Write()
                prof_4_charmflav_loosebtag_eff_pt[s].Write()
                prof_4_lightflav_mediumbtag_eff_pt[s].Write()
                prof_4_lightflav_loosebtag_eff_pt[s].Write()
